package com.practise.springboot_mail.controller;
...
public class EmailController {
    ...
    public String sendSimpleEmail() {
        try {
            ...
            message.setTo("1510675039@qq.com"); // 接收地址
    ...
    public String sendHtmlEmail() {
        ...
        try {
            ...
            helper.setFrom(from);
            helper.setTo("1510675039@qq.com"); // 接收地址
    ...
    public String sendAttachmentsMail() {
        ...
        try {
            ...
            // 传入附件
            FileSystemResource file = new FileSystemResource(new File("src/main/resources/static/file/1.docx"));
    ...
    public String sendInlineMail() {
        ...
        try {
            ...
            // 传入附件
            FileSystemResource file = new FileSystemResource(new File("src/main/resources/static/img/plane.bmp"));
